...
export default function LoginClient() {
  ...
  // ⬇️ Cole aqui o SEU JSX atual do formulário (o trecho grande que você mostrou).
  // Eu deixei um layout base para compilar de primeira. Você pode substituir
  // pelo seu markup completo sem mudanças de lógica.
  return (
        ...
        <div className="md:col-span-2 flex items-center justify-center p-7 md:p-10">
          <form onSubmit={onSubmit} className="w-full max-w-md" aria-describedby={error ? "login-error" : undefined}>
            ...
            <footer className="mt-8 text-[11px] text-slate-500">
              ...
              <a href="#" className="underline decoration-dotted">Termos</a>{" "}
              e{" "}
              <a href="#" className="underline decoration-dotted">Privacidade</a>.
            </footer>
          </form>
        </div>
      </div>
